    ...
    <div className="rounded-xl border border-input bg-card p-4 text-card-foreground shadow-sm">
      ...
      {isPremium ? (
        ...
        <button
          ...
          className="mt-3 inline-flex items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
